   ...
   <div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
    <form action="{{ route('cars.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex justify-center mt-8">
            <button type="submit" 
                    class="px-6 py-3 bg-blue-600 text-black font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                List My Car
            </button>
        </div>
    </form>
