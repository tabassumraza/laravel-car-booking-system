                                        ...
                                        @foreach($cars as $car)
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex space-x-3">
                                                        <button
                                                            class="text-indigo-600 hover:text-indigo-900 editBtn transition-colors"
                                                            data-id="{{ $car->id }}" data-name="{{ $car->name }}"
                                                            data-carnum="{{ $car->carnum }}" data-status="{{ $car->status }}"
                                                            data-description="{{ $car->description }}" title="Edit car">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                                viewBox="0 0 20 20" fill="currentColor">
                                                                <path
                                                                    d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-yellow-700">
                                            No cars found in the database. <a href="{{ route('admin.car.add') }}"
                                                class="font-medium underline text-yellow-700 hover:text-yellow-600">Add your
                                                first car</a>
                                        </p>
                                    </div>
                                </div>
